		...
		public void actionPerformed(ActionEvent e) {
			...
			for (JButton but : listday) {
				if (src.equals(but)) {
					...
					System.out.println(but.getLabel());
						...
						public void actionPerformed(ActionEvent e) {
							for (Dateday d : cal.getList()) {
								if ((but.getLabel().equals(d.getDay()) || ("0" + but.getLabel()).equals(d.getDay()))
									...
									updateDatabase(d.getDay(), d.getMount(), d.getYear(), d.getText());
									break;
								}
							}
						...
						public void actionPerformed(ActionEvent e) {
							for (Dateday d : cal.getList()) {
								if ((but.getLabel().equals(d.getDay()) || ("0" + but.getLabel()).equals(d.getDay()))
									...
									but.setBackground(Color.white);
									delteDatabase(d.getDay(),d.getMount(),d.getYear());
									break;
								}
							}
...
//						System.out.println(cal.getList());
	...
	public void addNever(String[] data, JTextArea area){
		...
		if (check == false) {
			...
			cal.getList().add(date);
			addDatabase(date.getDay(), date.getMount(), date.getYear(), date.getText());
		}
	}
